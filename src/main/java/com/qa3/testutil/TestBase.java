...
public class TestBase {
	...
	public TestBase() {
		prop = new Properties();
		try {
			FileInputStream ip = new FileInputStream("C:\\Users\\SING110\\Documents\\JAVARELATEDITEMS\\POMWorkspace\\CucumberUsingPOM"
					+ "\\src\\main\\java\\com\\qa3\\config\\config.properties");
			prop.load(ip);
